...
public class SimpleContentRestrictionConstraint : ContentConstraint<XsSimpleContentRestriction, XmlSchemaSimpleContentRestriction>
{
    ...
    public override string? GetActualName(XsSimpleContentRestriction actual) => null;
    public override string? GetExpectedName(XmlSchemaSimpleContentRestriction expected) => null;
}
