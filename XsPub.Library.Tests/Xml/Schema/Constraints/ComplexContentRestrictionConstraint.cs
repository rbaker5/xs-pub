...
public class ComplexContentRestrictionConstraint : ContentConstraint<XsComplexContentRestriction, XmlSchemaComplexContentRestriction>
{
    ...
    public override string? GetActualName(XsComplexContentRestriction actual) => null;
    public override string? GetExpectedName(XmlSchemaComplexContentRestriction expected) => null;
}
