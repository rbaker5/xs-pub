...
namespace XsPub.Library.Xml
{
    public abstract class XmlWrappingWriter : XmlWriter
    {
        ...
        {
            Contract.Requires<ArgumentNullException>(baseWriter != null);
