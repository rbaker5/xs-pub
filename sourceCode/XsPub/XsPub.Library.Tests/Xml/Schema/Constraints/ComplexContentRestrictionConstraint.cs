...
namespace XsPub.Library.Tests.Xml.Schema.Constraints
{
    public class ComplexContentRestrictionConstraint : ContentConstraint<XsComplexContentRestriction, XmlSchemaComplexContentRestriction>
    {
        ...
        public override string GetActualName(XsComplexContentRestriction actual)
        {
            return null;
        }

        public override string GetExpectedName(XmlSchemaComplexContentRestriction expected)
        {
            return null;
        }
    }
